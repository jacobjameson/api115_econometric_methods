...
```{r, eval=F}
reg.1 <- lm(realfinalprofit ~ cashtreat + equiptreat, data)

fe.reg <- felm(realfinalprofit ~ cashtreat + equiptreat|groupnum + wave, data)

stargazer(reg.1, fe.reg, type = "latex", header = FALSE)
...
\\[-1.8ex] & (1) & (2)\\ 
\hline \\[-1.8ex] 
 cashtreat & 11.653 & 11.178$^{*}$ \\ 
  & (7.662) & (6.716) \\ 
  & & \\ 
 equiptreat & 24.242$^{***}$ & 22.024$^{***}$ \\ 
  & (7.651) & (6.703) \\ 
  & & \\ 
 Constant & 112.049$^{***}$ &  \\ 
  & (4.461) &  \\ 
  & & \\ 
\hline \\[-1.8ex] 
Observations & 4,354 & 4,354 \\ 
R$^{2}$ & 0.002 & 0.276 \\ 
Adjusted R$^{2}$ & 0.002 & 0.241 \\ 
Residual Std. Error & 206.712 (df = 4351) & 180.301 (df = 4152) \\ 
F Statistic & 5.131$^{***}$ (df = 2; 4351) &  \\ 
\hline 
\hline \\[-1.8ex] 
