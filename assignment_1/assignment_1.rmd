...
\color{blue}
The particular sort of attrition mentioned in the article does not make me concerned about internal validity because the attrition is random.
\color{black}
...
\color{blue}
- Firms studied in this paper were microenterprises; this result may not generalize to medium-sized firms with employees 

- Firms were studied in two geographies in Ghana. These results may not generalize to other countries that may have different entrepreneurial cultures.

- Effects may differ if the government were to implement the program instead of researchers (e.g., maybe if entrepreneurs behave differently if they were given cash or in-kind grants from the government instead of as a “thank you” for completing a survey)

- Study cannot be generalized for larger injections of cash or equipment 
...
\color{blue}
To examine treatment effect heterogeneity across: gender mix of the industry that firms are in, high vs. low capture, initial capital stock and initial size of profits. From these results, the authors can conclude that in-kind grants only increase profits for female-owned firms that were larger initially. 
\color{black}
